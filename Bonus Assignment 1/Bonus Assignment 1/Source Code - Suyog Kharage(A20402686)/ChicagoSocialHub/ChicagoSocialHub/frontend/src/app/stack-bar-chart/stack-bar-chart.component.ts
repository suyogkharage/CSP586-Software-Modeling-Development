...
export class StackBarChartComponent implements OnInit {
  ...
  constructor(private placesService: PlacesService,private location: Location) { }
    ...
    this.placesService
      ...
      .subscribe((data: Station[]) => {
        ...
        this.stations.forEach(entry =>{
           this.bikes.push({stationName:entry.stationName,availableBikes:entry.availableBikes,availableDocks:entry.availableDocks}) 
        })
